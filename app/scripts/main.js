...
const applicationServerPublicKey = 'BExAPaLVuyBB-Hc7mso-HT3xOgCpLDObxKhBwzILSa-gS3_P3cieMdSgdrtpmk4ulcD2-Fu3M731sP3xd7VZhpE';
...
function unsubscribeUser() {
  swRegistration.pushManager.getSubscription() // 현재 구독을 가져옴
  .then(function(subscription) { // // PushSubscription으로 확인되는 프라미스가 존재할 경우 이런 프라미스가 반환되고, 존재하지 않으면 null이 반환
    if (subscription) { // 구독이 있을 경우 그 구독에 대해 unsubscribe()를 호출하여 PushSubscription을 무효화
